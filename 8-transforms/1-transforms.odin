...
vertexShaderSource :: string(#load("1-transforms.vs"))
fragShaderSource :: string(#load("1-transforms.fs"))
wallAsset :: "wall.png"
faceAsset :: "face.png"
...
main :: proc() {
	...
	for !glfw.WindowShouldClose(window) {
		...
		transform *= glm.mat4Translate(glm.vec3{0.5, -0.5, 0})
		transform *= glm.mat4Rotate(glm.vec3{0, 0, 1}, f32(glfw.GetTime()))

		gl.UseProgram(program)
		gl.UniformMatrix4fv(gl.GetUniformLocation(program, "transform"), 1, false, &transform[0][0])
