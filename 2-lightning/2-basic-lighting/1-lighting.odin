...
main :: proc() {
	...
	for !glfw.WindowShouldClose(window) {
		...
		lightPos = glm.vec3{lightPos.x, f32(math.sin(glfw.GetTime())), f32(math.cos(glfw.GetTime())) * 2 - 2}
		...
		gl.Uniform3fv(gl.GetUniformLocation(mainProgram, "lightPos"), 1, &lightPos[0])
